...
use crate::schema::{
    schema_has_invariants, ColumnMetadataKey, DataType, SchemaRef, StructField, StructType,
};
...
mod test {
    ...
    use crate::schema::{
        schema_ref, ColumnMetadataKey, ColumnName, DataType, MetadataValue, SchemaRef, StructField,
        StructType,
    };
    use crate::table_features::{
